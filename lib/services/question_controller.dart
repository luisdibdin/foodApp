...
class QuestionController {
  ...
  Future<int> checkAnswer(int answer, List<int> choices) async {
    int pos = choices.indexOf(correctValue.round());
    if (correctValue.round() == answer) {
      await _userController.updateUserScore(1, 1);
    } else {
      await _userController.updateUserScore(0, 1);
    }
    return pos;
  }
}